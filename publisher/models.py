...
class Widget(models.Model):
    ...
    def get_code(self):
        return "<script type='text/javascript'>(function(){var l=document.createElement('link');l.rel='stylesheet';l.type='text/css';l.href='"+settings.WIDGET_GENERATOR_DOMAIN+"/widget/"+str(self.pk)+"/css/';var s=document.getElementsByTagName('script')[0];s.parentNode.insertBefore(l,s);var j=document.createElement('script');j.type='text/javascript';j.async=true;j.src='"+settings.WIDGET_GENERATOR_DOMAIN+"/widget/"+str(self.pk)+"/js/';var s=document.getElementsByTagName('script')[0];s.parentNode.insertBefore(j,s);})();</script>"
