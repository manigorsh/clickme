    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('target_language', models.ManyToManyField(blank=True, help_text='Select A Target Language For This Widget (default all languages)', related_name='widget_target_language', to='advertiser.Language')),
            ],
        ),
    ]
